...
//             const clipRight = stackWidth - imgWidth - 20;
//             const clipBottom = stackHeight - imgHeight + 80;
        
//             setClipLeft(clipRight);
//             setClipTop(clipBottom);
//         };
        
//         const observer = new ResizeObserver(updateClip);
//         observer.observe(imageRef.current);
//         observer.observe(imageRef.current.closest('.stack')); // ← watch stack too
//         updateClip();
...
//             <div className="stack">
//                 <img src={Webbie} ref={imageRef} className="webbie" />
//                 <div className="text-layer">
//                     <div className="landing-text dark">
//                         Jake<br />Moore
//                     </div>
//                     <div className="landing-text light" style={{ clipPath: `inset(0 ${clipLeft}px ${clipTop}px 0)` }}>
//                         Jake<br />Moore
//                     </div>
//                 </div>
//             </div>
